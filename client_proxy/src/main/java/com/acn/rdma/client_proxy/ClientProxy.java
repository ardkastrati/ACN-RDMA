...
public class ClientProxy implements RdmaEndpointFactory<ClientProxy.CustomClientEndpoint> { 
	private String ipAddress;
	RdmaActiveEndpointGroup<ClientProxy.CustomClientEndpoint> endpointGroup;
	
	public ClientProxy.CustomClientEndpoint createEndpoint(RdmaCmId idPriv, boolean serverSide) throws IOException {
		return new CustomClientEndpoint(endpointGroup, idPriv, serverSide);
	}	
	
	public void run() throws Exception {
		//create a EndpointGroup. The RdmaActiveEndpointGroup contains CQ processing and delivers CQ event to the endpoint.dispatchCqEvent() method.
		endpointGroup = new RdmaActiveEndpointGroup<ClientProxy.CustomClientEndpoint>(1000, false, 128, 4, 128);
		...
		ClientProxy.CustomClientEndpoint endpoint = endpointGroup.createEndpoint();
...
//		System.exit(0);
	...
	public void launch(String[] args) throws Exception {
		...
		if (args.length < 1) {
			System.exit(0);
		} else if (args[0].equals(ClientProxy.class.getCanonicalName())) {
	...
	public static void main(String[] args) throws Exception { 
		ClientProxy simpleClient = new ClientProxy();
